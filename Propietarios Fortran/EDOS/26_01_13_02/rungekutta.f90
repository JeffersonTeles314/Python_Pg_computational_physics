! Escreva um código computacional em Fortran para resolver a equação diferencial
...
! dy
! dx
! na região 0 < x < 5 usando os seguintes métodos de
! (a) Euler
! (b) Runge–Kutta de quarta ordem
! Com y(0) = 1, y
! ′
! (0) = z(0) = 0.

! Faça um gráfico dos seus resultados para h = 0,05, 0,10, 0,15 e 0,20, juntamente
! com o resultado exato que é y = exp(−x
! 2
! /2). Para x = 3 faça uma comparação

! entre os resultados obtidos por Euler e Runge–Kutta de quarta ordem.
...
program edos
    ...
    yvals(0) = 1.0d0 ! Condi��o inicial (y_pvi)
