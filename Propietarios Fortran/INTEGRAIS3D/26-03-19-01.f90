...
!***********************************************************************
      ...
      REAL x, y, z
      func = (x**2.0d0) + (y**2.0d0) + (z**2.0d0) ! Digite aqui a função a ser integrada
      END
...
!***********************************************************************
      ...
      common /blc1/xmax
      REAL xmax
      z1=  -dsqrt(dabs((xmax**2.0d0)-(x**2.0d0)-(y**2.0d0)))  ! Digite aqui limite inferior de integração na direção z
      END
...
!***********************************************************************
      ...
      common /blc1/xmax
      REAL xmax
      z2=  dsqrt(dabs((xmax**2.0d0)-(x**2.0d0)-(y**2.0d0)))   ! Digite aqui limite superior de integração na direção z
      END
...
!***********************************************************************
      ...
      common /blc1/xmax
      REAL xmax
      y1= -dsqrt(dabs((xmax**2.0d0)-(x**2.0d0)))   ! Digite aqui limite inferior de integração na direção y
      END
...
!***********************************************************************
      ...
      common /blc1/xmax
      REAL xmax
      y2= dsqrt(abs((xmax**2.0d0)-(x**2.0d0)))  ! Digite aqui limite superior de integração na direção y
      END
